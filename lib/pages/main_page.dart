...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder: (context,ThemeModel th,child){
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: th.isDark ? Colors.grey[800] : Colors.grey[200],
        ...
        Column(children: [
          ...
          currPage==0? Center(
                        child: GestureDetector(
                          ...
                          child: SeeMore(
                                            color: th.isDark ? Color(0xff424242) : Color(0xffeeeeee),
                                            text: "see more",
                                          ),
                        )): Container()
        ]),
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 5),
                    SeeMore(text: "Update Dp", color: Color(0xffFF4A4A), isWhite: true)
                  ],
                ),
              ),
            ],
